...
export const About = () => {
  return (
    <div className="h-full flex w-full justify-center border border-[#495057] items-center mb-52 mt-30">
      <div className="flex">
        <div className="w-[85%] border border-[#495057] flex flex-col justify-between p-6">
          <div className="w-10 h-8 rounded-full bg-white mb-6"></div>
          <p className=" text-2xl font-thin mb-6 m-2 text-[#adadad] p-6">
        ...
        <div className="flex flex-col items-end text-right p-8">
          <p className="text-9xl font-extrabold mb-6">BEHIND THE CODE</p>
