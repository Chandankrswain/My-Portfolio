...
export const Menu = ({ onClose }: Props) => {
  ...
  const itemClass = (path: string) =>
    `text-6xl md:text-9xl font-black cursor-pointer transition-colors duration-300 ${
  ...
  return (
    <motion.div
      ...
      className="flex flex-col gap-10 md:gap-4 justify-center bg-[#141414] h-screen text-white relative overflow-hidden"
    >
      <button
        onClick={onClose}
      ...
      <div className="flex flex-col p-2 md:p-10 gap-6 items-start md:items-center justify-center ">
        ...
        >
          <span className="text-xl md:text-2xl">02 </span>PROJECTS
        </p>
        ...
        >
          <span className="text-xl md:text-2xl">03 </span>CONTACT ME
        </p>
      </div>
    </motion.div>
  );
